        ...
        <div class="navigation">
            ...
            <div class="main">
                ...
                <div class="containerr">
                    <form method="GET">
                        <div class="row">
                            <h3 class="signin" style="margin-bottom: 10px;">Registration</h3>
                        ...
                        <div class="row">
                            <input style="border-color: #03a9f4;" type="submit" value="Register" name="register">
                        </div>
                        <div style="margin-top: 10px;" class="register">Already have an account? <a href="signin.php">Login</a></div>
                    </form>
                </div>
            </div>
    </div>
